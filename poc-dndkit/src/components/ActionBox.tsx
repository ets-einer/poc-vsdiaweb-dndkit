...
export const ActionBox = ({ id, dragOverlay, opacidade }) => {
  ...
  return (
    <div style={style} className={opacidade+"w-80 h-48 bg-gray-300 rounded-lg ml-24"}>
        <div className=" border-b border-black flex flex-row justify-between"> 
          <input type="text" maxLength={29} placeholder="Nome" className="mb-2 mt-2 ml-2 bg-gray-300 w-60 placeholder-black outline-none" />
